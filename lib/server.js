...
const CONFLICT_STRATEGY_LATEST_WINS = 'latest-wins';
const CONFLICT_STRATEGY_LOCAL_WINS = 'local-wins';
const CONFLICT_STRATEGY_REMOTE_WINS = 'remote-wins';
 ...
 * @returns {*} Task.
 */
GitTaskServer.prototype.CONFLICT_STRATEGIES[CONFLICT_STRATEGY_LATEST_WINS] = function(localTask, remoteTask) {
 ...
 * @returns {*} Task.
 */
GitTaskServer.prototype.CONFLICT_STRATEGIES[CONFLICT_STRATEGY_LOCAL_WINS] = function(localTask, remoteTask) {
    return localTask;
};
 ...
 * @returns {*} Task.
 */
GitTaskServer.prototype.CONFLICT_STRATEGIES[CONFLICT_STRATEGY_REMOTE_WINS] = function(localTask, remoteTask) {
    return remoteTask;
};
 ...
 * @returns {*} Task.
 */
GitTaskServer.prototype.CONFLICT_STRATEGIES[CONFLICT_STRATEGY_MANUAL] = function(localTask, remoteTask) {
    return remoteTask;
};
...
GitTaskServer.prototype.mergeAllTasks = function(localTasks, remoteTasks, getIdFn, strategy) {
    ...
    remoteTasks.forEach(function(remoteTask) {
        ...
        var mergedTask = (typeof localTask === 'undefined') ?
            remoteTask :
            this.CONFLICT_STRATEGIES[strategy](localTask, remoteTask);
