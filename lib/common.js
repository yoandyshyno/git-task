...
/**
 * Replace all line changes with the symbol given.
 * @param sym Use this symbol to replace all line changes.
 * @returns {string} String with all line changes converted to a symbol.
 */
String.prototype.fixEOL = function(sym) {
    return this.replaceAll('\r\n', sym).replaceAll('\n', sym).replaceAll('\r', sym);
};
